<x-app-layout>
    ...
    @foreach ($users as $user)
        <div class="flex justify-between items-center max-w-7xl mx-auto space-y-2 px-6 py-4 bg-gray-50 hover:bg-white rounded-md shadow-md">
            <div>
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <a href="#"
                        class="self-center text-gray-400 hover:text-green-600 transform hover:scale-150"
                    >
            ...
            <div class="flex space-x-4">
                <a href="{{ route('users.show', $user) }}"
                    class="flex justify-end items-center space-x-2 focus:outline-none text-gray-400
                    hover:text-green-600 transform hover:scale-110"
                >
